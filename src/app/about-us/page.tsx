...
const StarIcon = () => (
  <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M1.33301 9.2722C1.01976 8.98251 1.18992 8.45882 1.61361 8.40858L7.61719 7.69649C7.78987 7.67602 7.93986 7.56758 8.0127 7.40967L10.5449 1.91989C10.7236 1.53245 11.2744 1.53238 11.4531 1.91981L13.9854 7.40956C14.0582 7.56746 14.2072 7.67619 14.3799 7.69667L20.3838 8.40858C20.8075 8.45882 20.9772 8.98267 20.6639 9.27235L16.2258 13.3773C16.0981 13.4954 16.0413 13.6711 16.0752 13.8417L17.2531 19.7714C17.3362 20.1899 16.8908 20.5141 16.5185 20.3057L11.2432 17.352C11.0915 17.2671 10.9071 17.2675 10.7554 17.3524L5.47949 20.305C5.10718 20.5134 4.66099 20.1898 4.74414 19.7714L5.92219 13.8421C5.95608 13.6715 5.89938 13.4954 5.77172 13.3773L1.33301 9.2722Z" stroke="#FD6A4C" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);

const QualityIcon = () => (
  <svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M17.2519 15.1586L17.3798 13.5595C17.412 13.1567 17.5708 12.7745 17.833 12.4669L18.873 11.2451C19.4847 10.5273 19.4846 9.47189 18.8729 8.75406L17.8329 7.53295C17.5707 7.22535 17.4117 6.84284 17.3795 6.43997L17.2524 4.84117C17.1774 3.90104 16.4306 3.15427 15.4905 3.07925L13.8915 2.95132C13.4886 2.91918 13.1066 2.76167 12.799 2.49953L11.5781 1.45904C10.8603 0.847313 9.80382 0.847313 9.08599 1.45904L7.86488 2.49908C7.55728 2.76121 7.17477 2.92005 6.7719 2.9522L5.1728 3.07981M17.2529 15.1592C17.1778 16.0994 16.4313 16.8459 15.4912 16.9209M15.4907 16.92L13.8916 17.0476C13.4887 17.0797 13.1064 17.2378 12.7988 17.5L11.5781 18.541C10.8603 19.1527 9.80371 19.1528 9.08589 18.5411L7.86519 17.501C7.55758 17.2389 7.17528 17.0801 6.77241 17.0479L5.1728 16.92M5.17376 16.9209C4.23363 16.8459 3.48708 16.0994 3.41206 15.1592L3.28413 13.5596C3.25198 13.1568 3.09314 12.7745 2.83101 12.4668L1.79097 11.2461C1.17924 10.5283 1.17896 9.47178 1.79068 8.75396L2.83166 7.53326C3.09379 7.22565 3.25111 6.84335 3.28326 6.44048L3.41118 4.84087M3.41206 4.84183C3.48708 3.9017 4.23363 3.15515 5.17376 3.08013" stroke="#9676AD" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);

const FlexibilityIcon = () => (
  <svg width="22" height="20" viewBox="0 0 22 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M13.168 17.5C13.168 15.2909 10.4817 13.5 7.16797 13.5C3.85426 13.5 1.16797 15.2909 1.16797 17.5M17.168 14.5V11.5M17.168 11.5V8.5M17.168 11.5H14.168M17.168 11.5H20.168M7.16797 10.5C4.95883 10.5 3.16797 8.70914 3.16797 6.5C3.16797 4.29086 4.95883 2.5 7.16797 2.5C9.37711 2.5 11.168 4.29086 11.168 6.5C11.168 8.70914 9.37711 10.5 7.16797 10.5Z" stroke="#94CCB8" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);

export const metadata: Metadata = {
  title: "About Us",
  description: "At Event Sitters, we create fun, engaging spaces where kids can enjoy tailored activities at events. A dedicated team ensures every child has a great time!",
          ...
          <div className="w-layout-layout portrait-grid wf-layout-layout">
            ...
            <div className="w-layout-cell cell">
              <div className="festivals-markets-text-wrapper">
                <div className="paragraph-wrapper">
                  <p className="p-medium">I&apos;m Samantha, the proud owner of Event Sitters. With a postgraduate diploma in Early Childhood Education and years of experience working with children in kindergartens, care centres and homes, I&apos;ve learned what matters in creating joyful experiences for children.</p>
                  <p className="p-medium">For me, it&apos;s all about sparking their curiosity and keeping them engaged through fun, meaningful play – putting their joy at the heart of everything we do.</p>
                </div>
              </div>
              <blockquote className="quote">I want children&apos;s enter­tain­ment to spark joy, fuel curiosity, and engage hands‑on play.</blockquote>
